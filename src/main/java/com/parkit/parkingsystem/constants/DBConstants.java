...
/**
 * Constants represents the requete sql to database
 * @author moi
 *
 */
public class DBConstants {
    ...
    public static final String IS_RECURRING_USER ="select count(*) as recordCount from ticket t where t.OUT_TIME is not null and t.VEHICLE_REG_NUMBER = ?";
}
